        ...
        <form method="POST" action="{{ route('settings.school.update') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="school_name" name="school_name" value="{{ old('school_name') }}" class="w-full rounded-lg border-gray-300 shadow-sm">
                    @error('school_name')
                ...
                <div>
                    ...
                    <input type="text" id="class_name" name="class_name" value="{{ old('class_name') }}" class="w-full rounded-lg border-gray-300 shadow-sm">
                    @error('class_name')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
