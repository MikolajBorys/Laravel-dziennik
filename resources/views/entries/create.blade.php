    ...
    <div class="space-y-6">
        ...
        <div class="bg-white/50 backdrop-blur-md rounded-2xl border border-white/70 shadow-sm p-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                <div class="w-12 h-12 rounded-xl bg-indigo-100/60 flex items-center justify-center flex-shrink-0">
                    <svg class="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.5v15m7.5-7.5h-15"/>
                    </svg>
                </div>
                <div>
                    <h3 class="text-xl font-bold text-slate-800">Nowy wpis dzienny</h3>
                    <p class="text-sm text-slate-500 mt-0.5">Uzupełnij dane dotyczące dnia praktyk.</p>
                </div>
            </div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="tasks"
                                              ...
                                              class="block w-full pl-11 pr-4 py-3 rounded-xl
                                                     ...
                                                     focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400
                                                     transition duration-200 resize-y">{{ old('tasks') }}</textarea>
                                </div>
                                @error('tasks')
                                    <p class="text-red-600 text-sm mt-1.5 flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z"/></svg>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="notes"
                                              ...
                                              class="block w-full pl-11 pr-4 py-3 rounded-xl
                                                     ...
                                                     text-slate-800 placeholder-slate-400
                                                     focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400
                                                     transition duration-200 resize-y">{{ old('notes') }}</textarea>
                                </div>
                                @error('notes')
                                    <p class="text-red-600 text-sm mt-1.5 flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z"/></svg>
